      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-[42%] relative overflow-hidden bg-[#f6f9f4] border-r border-[#a9bb9d]/15 flex-col justify-between p-12">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <h1 className="text-4xl xl:text-5xl font-bold text-[#1a1a1a] tracking-tight leading-[1.15]">
            Start your
            <br />
            <span className="text-[#a9bb9d]">personalized journey.</span>
          </h1>
          <p className="text-[#777] text-sm leading-relaxed max-w-sm">
            Create your account to access AI-powered pharmacogenomic insights
          ...
          <div className="space-y-3 pt-4">
            {[
              ...
              { icon: "🛡️", text: "Evidence-based safety insights" },
              { icon: "👥", text: "Connect with your genetic community" },
            ].map((b) => (
        ...
        <div className="w-full max-w-md">
          ...
          {!selectedRole ? (
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h2 className="text-xl font-bold text-[#1a1a1a] tracking-tight">
                    {ROLES[selectedRole].label} Sign Up
                  </h2>
              ...
              {error && (
                <div className="mb-4 px-4 py-2.5 rounded-xl bg-red-50 border border-red-100 text-red-600 text-xs font-medium">
                  {error}
                </div>
              )}
              ...
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl font-semibold text-sm text-white transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer mt-2"
                  style={{
