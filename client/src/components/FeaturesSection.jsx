...
export default function FeaturesSection() {
    return (
        <section className="py-24 px-4 bg-gradient-to-b from-white to-[#f8faf8]">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <div>
                        <div className="inline-flex items-center gap-2 bg-white/10 text-[#a9bb9d] text-xs font-bold px-3 py-1 rounded-full mb-3 tracking-widest uppercase">
                            Open Beta
                        </div>
