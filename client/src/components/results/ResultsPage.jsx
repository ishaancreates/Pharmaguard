    ...
    >
      ...
      <div
        className={`text-3xl font-bold tracking-tight ${
          alert ? "text-red-600" : "text-[#1a1a1a]"
        }`}
      >
        {value}
      </div>
  ...
  return (
    <div className="rounded-2xl overflow-hidden border border-[#a9bb9d]/15 bg-white transition-shadow hover:shadow-sm">
      ...
      >
        ...
        <IconChevronDown
          className={`w-5 h-5 shrink-0 text-[#a9bb9d]/50 transition-transform duration-300 ${
            isOpen ? "rotate-180" : ""
          }`}
        />
      </button>
        ...
        <div className="px-4 pb-4 border-t border-[#a9bb9d]/10">
          ...
          <div className="space-y-2">
            {gene.detectedAlleles.map((a, ai) => (
              <div
                key={ai}
                className={`text-xs rounded-xl p-3 border font-mono ${
                  a.isVariant
